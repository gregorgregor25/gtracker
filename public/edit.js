...
async function loadForm() {
  try {
    ...
    document.getElementById('treadmill_minutes').value =
      entry.treadmill_minutes || '';
    document.getElementById('treadmill_distance_km').value =
      entry.treadmill_distance_km || '';

    const fallbackCalories =
      entry.calories_total ?? entry.calories_burned ?? '';
    document.getElementById('calories_gym').value =
      entry.calories_gym ?? fallbackCalories;
    document.getElementById('calories_treadmill').value =
